...
var Contest = function () {
  ...
  _createClass(Contest, [{
    ...
    key: 'method',
    value: function method(contract, statement, values) {
      var _this2 = this;
      ...
      return global.describe(statement, function () {
        return keys.forEach(function (key) {
          ...
          var expected = values[key].value || values[key];
          var transform = values[key].transform;
          return _this2.assert(method, 'value of \'' + key + '\' is correct', [[[], expected]], transform);
        });
      });
    }
  }, {
    key: 'param',
    value: function param(method, describe, it, obj) {
      return this.suite(method, describe, [['assert ' + it, Object.keys(obj).map(function (key) {
        return [[key], [obj[key]]];
      })]]);
    }
  }, {
    ...
    value: function assert() {
      ...
      return (0, _methodTester2.default)('assert', opts, function (_ref) {
        ...
        return promise.then(function (outs) {
          var outputs = (0, _helpers.arrayify)(outs);
