...
var _tempo = require('@digix/tempo');
...
var Contest = function () {
  ...
  _createClass(Contest, [{
    ...
    value: function artifact(truffleArtifact) {
      var _init = this._init.bind(this);
    ...
    key: 'wait',
    value: function wait(blocks, numberOfSeconds) {
      var _this = this;
      ...
      return this.then(function () {
        return new Promise(function (resolve) {
          ...
          _this.tempo.waitForBlocks(blocks, numberOfSeconds).then(resolve);
        });
      });
    }
    ...
    key: '_init',
    value: function _init(contract) {
      var _this2 = this;

      return new Promise(function (resolve) {
        _assert2.default.ok(contract.address);
        _this2._setContract(contract);
        new _tempo2.default(global.web3).then(function (instance) {
          _this2.tempo = instance;
          resolve();
        });
      });
    }
      ...
      this._addToQueue({
        promise: function promise() {
          ...
          return new Promise(function (resolve, reject) {
            var p = _promise(_this3._getContract());
            if (p && p.then) {
